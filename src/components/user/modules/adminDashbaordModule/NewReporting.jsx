...
/>
            ...
            <div className="flex justify-center">
              <button type="submit" className="bg-[#0A3A2A] text-white py-2 px-4 rounded hover:bg-[#4D9981] ml-4">
                Submit
              </button>
              <button type="button" className="bg-[#0A3A2A] text-white py-2 px-4 rounded hover:bg-[#4D9981] ml-4" onClick={handleClose}>
                Cancel
              </button>
            </div>
          </form>
