  ...
  return (
    <div className=" mt-6">
      <div>
        ...
        {toggle && (
               <form onSubmit={handleSubmit} className=" z-20 absolute bg-white border p-2  translate-x-[-6.8rem] rounded shadow-md mt-4">
               <div className="my-8 ">
                 ...
                 <input
                   ...
                   className="mt-1 p-2 border border-gray-300 rounded-md w-full uppercase"
                 />
               </div>
